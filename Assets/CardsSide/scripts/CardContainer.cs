...
public class CardContainer : MonoBehaviour
{
    ...
    public void mapData(GameObject card)
    {
        ...
        CM.Support = cardObj.supportCards;
        CM.stun = cardObj.stun;
        CM.AddCardsNow = cardObj.addCardsNow;
        CM.AddCardsInNextTurn = cardObj.addCardsInNextTurn;
        ...
        CM.reduceEnemyArmor = cardObj.ReduceEnemyArmor;
        CM.checkNextMove = cardObj.checkMoveDamage;
        CM.RandomEnemyAttack = cardObj.randomEnemyAttack;
        CM.DamageOnNextTurn = cardObj.DamageOnNextTurn;
        CM.DefenceOnNextTurn = cardObj.DefenceOnNextTurn;
